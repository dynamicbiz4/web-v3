          ...
          <div className="mb-8 flex gap-10 md:flex-col-reverse">
            ...
            <form className="w-2/3 md:w-full h-full space-y-12 text-base" action="https://formspree.io/f/mkneaplp" method="POST">
              <div>
                ...
                <div className="flex mb-6 space-x-3">
                  <div className="w-full md:w-1/2 md:mb-0">
                    ...
                    <input className="appearance-none block w-full border-b bg-inherit py-2 focus:px-2 outline-none" id="grid-first-name" type="text" name="firstName" placeholder="Bruce" required />
                  </div>
                  <div className="w-full md:w-1/2">
                    <label htmlFor="lastName">Last Name*</label>
                    <input className="appearance-none block w-full border-b bg-inherit py-2 focus:px-2 outline-none" id="grid-last-name" type="text" name="lastName" placeholder="Wayne" required />
                  </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    <label htmlFor="email">Email*</label>
                    <input className="appearance-none block w-full border-b bg-inherit py-2 focus:px-2 outline-none" id="email" type="email" name="mail" placeholder="bruce@waynecorp.com" required />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-4">
                  <input type="number" className="bg-inherit py-2 focus:pl-2 border-b w-28 outline-none" for="budget" min={35000} placeholder="35000" />
                </div>
              </div>
              ...
              <div>
                <div className="flex flex-wrap -mx-3 mb-4">
                  <div className="w-full px-3">
                    ...
                    <textarea
                      className="h-auto block w-full border-b bg-inherit py-2 focus:px-2 outline-none"
                      id="description"
                      name="message"
