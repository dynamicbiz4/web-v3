  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="container max-w-6xl text-lg mt-20 sm:my-10">
          ...
          <button className="btn w-fit mt-4 sm:w-full" onClick={() => handleShowDetails(!showDetails)}>
            {showDetails ? "Hide Details" : "Show Details"}
          </button>
        </section>

        <section className={`container max-w-6xl text-lg mt-4 sm:-mt-4 ${showDetails ? "block" : "hidden"}`}>
          <div className="p-8 border border-neutral-700 sm:p-4">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-8 sm:grid-cols-1 md:gap-4">
                <div className="flex flex-col justify-between border border-neutral-500 border-dashed p-8 md:p-4 sm:p-8">
            ...
            <div className="mt-8">
              <h2 className="text-3xl uppercase text-neutral-300">Building Blocks</h2>

              <div className=" max-w-3xl flex gap-8 w-full flex-wrap mt-8 sm:gap-6">
                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.react}</div>
                  <p className="text-sm">ReactJS</p>
                </div>
                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.nextjs}</div>
                  <p className="text-sm">NextJS</p>
                </div>

                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.sanity}</div>
                  <p className="text-sm">Sanity</p>
                </div>

                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.supabase}</div>
                  <p className="text-sm">Supabase</p>
                </div>

                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.firebase}</div>
                  <p className="text-sm">Firebase</p>
                </div>

                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.medusa}</div>
                  <p className="text-sm">MedusaJS</p>
                </div>

                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.vercel}</div>
                  <p className="text-sm">Vercel</p>
                </div>
                <div className="fill-white space-y-2 w-fit m-auto">
                  <div className="h-10 w-fit m-auto sm:h-10">{Icons.netlify}</div>
